...
function quemalabs_getting_started_menu() {
	add_theme_page( esc_attr__( 'Theme Info', 'reyl-pro' ), esc_attr__( 'Theme Info', 'reyl-pro' ), 'manage_options', 'reyl_pro_theme-info', 'quemalabs_getting_started_page' );
}
...
function quemalabs_getting_started_page() {
	if ( ! current_user_can( 'manage_options' ) )  {
		wp_die( esc_html__( 'You do not have sufficient permissions to access this page.', 'reyl-pro' ) );
	}
	...
	<div class="getting-started-header">
		<div class="header-wrap">
			...
			<div class="theme-content">
				...
				<h4><?php esc_html_e( 'Getting Started', 'reyl-pro' ); ?></h4>
				<h2 class="theme-name"><?php echo esc_html( QL_THEME_NAME ); ?> <span class="ver"><?php echo 'v' . esc_html( QL_THEME_VERSION ); ?></span></h2>
				<p><?php echo sprintf( esc_html__( 'Thanks for using %s, we appriciate that you create with our products.', 'reyl-pro' ), esc_html( QL_THEME_NAME ) ); ?></p>
				<p><?php esc_html_e( 'Check the content below to get started with our theme.', 'reyl-pro' ); ?></p>
				</div>
				...
				<ul class="getting-started-menu">
					...
					?>
					<li><a href="?page=reyl_pro_theme-info&amp;tab=docs" class="<?php echo ( $tab == 'docs' ) ? ' active' : ''; ?>"><i class="fa fa-file-text-o"></i> <?php esc_html_e( 'Documentation', 'reyl-pro' ); ?></a></li>
					<li><a href="?page=reyl_pro_theme-info&amp;tab=license" class="<?php echo ( $tab == 'license' ) ? ' active' : ''; ?>"><i class="fa fa-key"></i> <?php esc_html_e( 'License', 'reyl-pro' ); ?></a></li>
					<!-- <li><a href="https://www.quemalabs.com/theme/reyl-pro/" target="_blank"><i class="fa fa-star-o"></i> <?php esc_html_e( 'PRO Version', 'reyl-pro' ); ?></a></li> -->
					<!-- <li><a href="?page=reyl_pro_theme-info&amp;tab=more-themes" class="<?php echo ( $tab == 'more-themes' ) ? ' active' : ''; ?>"><i class="fa fa-wordpress"></i> <?php esc_html_e( 'More Themes', 'reyl-pro' ); ?></a></li> -->
					 <li><a href="https://quemalabs.ticksy.com/" target="_blank"><i class="fa fa-support"></i> <?php esc_html_e( 'Support', 'reyl-pro' ); ?></a></li>
				</ul>
	...
	if ( $pagenow == 'themes.php' && $_GET['page'] == 'reyl_pro_theme-info' ){
		if ( isset ( $_GET['tab'] ) ){
			$tab = $_GET['tab'];
		}else{
			$tab = 'docs';
	...
	?>
			...
			<div class="theme-docuementation">
				<div class="help-msg-wrap">
					<div class="help-msg"><?php echo sprintf( esc_html__( 'You can find this documentation and more at our %sHelp Center%s.', 'reyl-pro' ), '<a href="https://www.quemalabs.com/help-center/" target="_blank">', '</a>' ); ?></div>
				</div>
				<?php
				$url = wp_nonce_url( 'themes.php?page=reyl_pro_theme-info', 'more-themes' );
					...
					<div class="ql-theme">
						...
						<div class="ql-theme-info">
							...
							if( 'premium' == $theme->type ){
								$type = esc_html__( 'Premium', 'reyl-pro' );
							}else{
								$type = esc_html__( 'Free', 'reyl-pro' );
							}
							?>
